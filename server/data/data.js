export const kpis = [
  {
    ...
    monthlyData: [
      { month: "january", revenue: "$6125.64", expenses: "$4231.73", operationalExpenses: "$3900.03", nonOperationalExpenses: "$331.70" },
      { month: "february", revenue: "$6125.64", expenses: "$4677.84", operationalExpenses: "$3900.03", nonOperationalExpenses: "$777.81" },
      { month: "march", revenue: "$6125.64", expenses: "$4664.03", operationalExpenses: "$3900.03", nonOperationalExpenses: "$764.00" },
      { month: "april", revenue: "$6125.64", expenses: "$6336.52", operationalExpenses: "$3900.03", nonOperationalExpenses: "$2436.49" },
      { month: "may", revenue: "$7125.64", expenses: "$5224.61", operationalExpenses: "$3900.03", nonOperationalExpenses: "$1324.58" },
      { month: "june", revenue: "$7225.64", expenses: "$4566.61", operationalExpenses: "$3900.03", nonOperationalExpenses: "$666.58" },
      { month: "july", revenue: "$7140.64", expenses: "$6987.81", operationalExpenses: "$3900.03", nonOperationalExpenses: "$3087.78" },
      { month: "august", revenue: "$6647.29", expenses: "$8213.71", operationalExpenses: "$3900.03", nonOperationalExpenses: "$4313.68" },
      { month: "september", revenue: "$9344.07", expenses: "$12405.92", operationalExpenses: "$8900.03", nonOperationalExpenses: "$3505.89" },
      { month: "october", revenue: "$7110.22", expenses: "$4990.58", operationalExpenses: "$3900.03", nonOperationalExpenses: "$1090.55" },
      { month: "november", revenue: "$8655.03", expenses: "$7140.80", operationalExpenses: "$3900.03", nonOperationalExpenses: "$3240.77" },
      { month: "december", revenue: "$7155.75", expenses: "$5526.97", operationalExpenses: "$3900.03", nonOperationalExpenses: "$1626.94" },
    ],
...
export const products = [
  { name: "Electric Bill", price: "$120.50", category: "Utilities" },
  { name: "Water Bill", price: "$45.75", category: "Utilities" },
  { name: "Internet Subscription", price: "$60.00", category: "Utilities" },
  { name: "Mobile Phone Plan", price: "$59.27", category: "Utilities" },
  { name: "Grocery Shopping", price: "$130.25", category: "Groceries" },
  { name: "Grocery Run - Organic Produce", price: "$137.95", category: "Groceries" },
  { name: "Specialty Coffee Beans", price: "$34.58", category: "Groceries" },
  { name: "Take-out Dinner", price: "$25.90", category: "Dining Out" },
  { name: "Restaurant Visit", price: "$75.00", category: "Dining Out" },
  { name: "Lunch at The Green Cafe", price: "$23.19", category: "Dining Out" },
  { name: "Car Fuel", price: "$50.60", category: "Transportation" },
  { name: "Bus Pass", price: "$92.00", category: "Transportation" },
  { name: "Gasoline Refill", price: "$45.39", category: "Transportation" },
  { name: "Annual Car Service", price: "$299.99", category: "Transportation" },
  { name: "Streaming Service", price: "$15.99", category: "Entertainment" },
  { name: "Cinema Tickets", price: "$30.00", category: "Entertainment" },
  { name: "Concert Tickets", price: "$120.00", category: "Entertainment" },
  { name: "Netflix Monthly Subscription", price: "$13.99", category: "Entertainment" },
  { name: "Gaming Console", price: "$429.49", category: "Entertainment" },
  { name: "Massage Therapy Session", price: "$110.25", category: "Entertainment" },
  { name: "Haircut", price: "$35.00", category: "Personal Care" },
  { name: "Spa Day", price: "$200.00", category: "Personal Care" },
  { name: "Yoga Classes Package", price: "$150.29", category: "Personal Care" },
  { name: "New Sneakers", price: "$120.00", category: "Clothing" },
  { name: "Winter Jacket", price: "$250.00", category: "Clothing" },
  { name: "Summer Dress", price: "$65.40", category: "Clothing" },
  { name: "Sportswear Outfit", price: "$97.75", category: "Clothing" },
  { name: "Savings Deposit", price: "$500.00", category: "Savings & Investments" },
  { name: "IRA Contribution", price: "$300.00", category: "Savings & Investments" },
  { name: "Stock Purchase", price: "$150.00", category: "Savings & Investments" },
  { name: "Yearly Gym Membership", price: "$650.00", category: "Savings & Investments" },
  { name: "Quarterly Savings Deposit", price: "$550.00", category: "Savings & Investments" },
  { name: "Cryptocurrency Investment", price: "$700.22", category: "Savings & Investments" },
  { name: "Birthday Gift", price: "$50.00", category: "Gifts & Donations" },
  { name: "Charity Donation", price: "$75.00", category: "Gifts & Donations" },
  { name: "Anniversary Present", price: "$250.95", category: "Gifts & Donations" },
  { name: "Fundraiser Gala Donation", price: "$500.00", category: "Gifts & Donations" },
  { name: "Wedding Gift", price: "$200.00", category: "Gifts & Donations" },
  { name: "Christmas Charity", price: "$300.58", category: "Gifts & Donations" },
  { name: "Pharmacy Rx", price: "$25.00", category: "Healthcare" },
  { name: "Dental Checkup", price: "$200.00", category: "Healthcare" },
  { name: "Prescription Medication", price: "$39.20", category: "Healthcare" },
  { name: "Chiropractor Appointment", price: "$90.00", category: "Healthcare" },
  { name: "Pet Vet Visit", price: "$183.75", category: "Healthcare" },
  { name: "Life Insurance Premium", price: "$150.00", category: "Insurance" },
  { name: "Auto Insurance Premium", price: "$100.00", category: "Insurance" },
  { name: "Home Insurance Premium", price: "$125.00", category: "Insurance" },
  { name: "Pet Insurance", price: "$30.00", category: "Insurance" },
  { name: "Homeowner's Insurance", price: "$98.70", category: "Insurance" },
  { name: "Travel Insurance", price: "$150.00", category: "Insurance" },
  { name: "Bookstore Purchase", price: "$45.00", category: "Education" },
  { name: "Professional Certification", price: "$350.50", category: "Education" },
  { name: "Art Supplies", price: "$47.93", category: "Education" },
];
